...
def main():
    ...
    output_file = os.path.join(script_dir, "Pamiętnik_Finalny_Dane_Stopnie.xlsx")
    ...
    for row in range(5, ws_in.max_row + 1):
        ...
        if res:
            ws_out.append([
                ...
                res['wd_850'], res['ws_850'],
                res['wd_700'], res['ws_700'],
                res['ws_500'], res['min_li'], res['max_cape']
            ])

    wb_out.save(output_file)
    print(f"\nZapisano dane ze stopniami do {output_file}.")
